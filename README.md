...
> 
# Stellar Connect SDK Go — v1 Implementation Guide
...
```bash
go get github.com/stellar-connect/sdk-go
```

**Module path**: `github.com/stellar-connect/sdk-go`
...
```go
import "github.com/stellar-connect/sdk-go/signers"
...
```go
import "github.com/stellar-connect/sdk-go/store/memory"
...
```go
import "github.com/stellar-connect/sdk-go/anchor"
...
```go
import "github.com/stellar-connect/sdk-go/core/toml"
...
```go
import "github.com/stellar-connect/sdk-go/observer"
...
```go
import "github.com/stellar-connect/sdk-go/sdk"
...
```go
import "github.com/stellar-connect/sdk-go/errors"
